...
func compareEntry(fs base.FileStore, path string, entry wire.BlockRef, test_temp_file string) error {
	fn := path + "/" + entry.Name
...
func CompareTree(fs base.FileStore, path string, ref wire.BlockRef, test_temp_file string) error {
